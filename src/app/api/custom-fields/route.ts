...
export async function POST(req: Request) {
  ...
  const field_type = body.field_type === "number" ? "number" : body.field_type === "select" ? "select" : "text";
  ...
  const order_index = typeof body.order_index === "number" ? body.order_index : (count ?? 0);
